...
(function() {
    ...
    var APP_NAME = "MYPROFILE"; // <=== REPLACE VALUE (Caption of the Tablet button.)
    var APP_URL = ROOT + "index.html"; // <=== REPLACE VALUE (html page that will be your UI)
    var APP_ICON_INACTIVE = ROOT + "icons/inactive.png"; // <=== REPLACE VALUE (Provide a 50 X 50 pixels, .png or .svg file, WHITE on transparent background)
    var APP_ICON_ACTIVE = ROOT + "icons/active.png"; // <=== REPLACE VALUE  (Provide a 50 X 50 pixels, .png or .svg file, BLACK on transparent background)
    var appStatus = false;
    var channel = "overte.application.more.zardsmyprofile"; // <=== REPLACE VALUE  (This must be a string specific to this application for a private communication between the app and its UI(html). The value must the same in template.html too.)
    var timestamp = 0;
